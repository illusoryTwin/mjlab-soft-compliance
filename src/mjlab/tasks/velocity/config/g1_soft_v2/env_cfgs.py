...
def unitree_g1_soft_v2_env_cfg(
  ...
  # ── Standing only (zero velocity commands) ──
  ...
  cfg.observations["actor"].terms["stiffness_command"] = ObservationTermCfg(
    func=mdp.generated_commands,
  ...
  # ── Compliant joint-position tracking reward ──
  # Starts at 0.0; ramped by curriculum below.
